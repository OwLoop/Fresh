...
class Hybrid_Providers_Google extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->gender        = (property_exists($response,'gender'))?strtolower($response->gender):"";
		...
		$this->user->profile->relationship  = (property_exists($response,'relationshipStatus'))?strtolower($response->relationshipStatus):"unknown";
