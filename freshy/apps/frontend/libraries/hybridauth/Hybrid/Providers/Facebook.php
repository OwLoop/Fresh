...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->gender        = (array_key_exists('gender',$data))?strtolower($data['gender']):"";
		...
		$this->user->profile->relationship = (array_key_exists('relationship_status',$data))?strtolower($data['relationship_status']):"unknown";
